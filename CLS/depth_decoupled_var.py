...
class DecoupledFNNBlockFn(Function):
    ...
    def backward(ctx, grad_y, grad_x_fwd_diff=None, grad_y_fwd_diff=None):
        ...
        grad_h_from_x = inv_sqrt_n * (grad_x @ U_bwd)  # [..., n]
...
class DecoupledAttBlockFn(Function):
    ...
    def backward(ctx, grad_y,q_diff=None, k_diff=None, v_diff=None, logits_diff=None, attn_diff=None):
        ...
        # decoupled: grad_out_merge = grad_out_proj @ o_bwd   (而不是 o_fwd)
        grad_out_merge = grad_out_proj @ o_bwd               # [b,n,d_model]
        ...
        # decoupled: 回传到 h 使用 backward weights
        grad_h_from_q = grad_query @ q_bwd        # [b,n,d_model]
        grad_h_from_k = grad_key   @ k_bwd
        grad_h_from_v = grad_value @ v_bwd
        ...
        return (
            ...
            grad_q_bwd, grad_k_bwd, grad_v_bwd, grad_o_bwd,
            grad_q_fwd_copy, grad_k_fwd_copy, grad_v_fwd_copy, grad_o_fwd_copy,
            grad_alpha,
            grad_inv_sqrt_n,
            grad_num_heads,
            grad_softmax,
